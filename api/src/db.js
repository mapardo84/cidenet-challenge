...
const Empleado = sequelize.define('empleado', {
    ...
    country:   { type: DataTypes.TEXT,   allowNull: false, validate: { isAlpha: true } },
    idType:    { type: DataTypes.STRING, allowNull: false, validate: { isAlpha: true } },
    ...
    area:      { type: DataTypes.STRING, allowNull: false, validate: { isAlpha: true } },
