    ...
    return (
        <div className='register-conteiner'>
            ...
            <form className='form-inputs' id='registro' onSubmit={handleSubmit}>
                ...
                <input className='input-register' required form='registro' onChange={handleOnChange} type='text' id='name1' name='name1' value={employee.name1}></input>
                <label htmlFor='name2'>Segundo Nombre </label>
                <input className='input-register' placeholder='opcional' onChange={handleOnChange} type='text' id='name2' name='name2' value={employee.name2}></input>
                <label htmlFor='lastName1'>Primer Apellido </label>
                <input className='input-register' onChange={handleOnChange} type='text' id='lastName1' name='lastName1' value={employee.lastName1} required></input>
                <label htmlFor='lastName2'>Segundo Apellido </label>
                <input className='input-register' onChange={handleOnChange} type='text' id='lastName2' name='lastName2' required value={employee.lastName2}></input>
                ...
                <select className='input-register' onChange={handleOnChange} id='area' name='area' required value={employee.area}>
                    ...
                    <option value='rh'>Talento Humano</option>
                    <option value='serv'>Servicios Varios</option>
                </select>
